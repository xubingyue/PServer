...
REALCC=$(CC) $(CFLAGS) $(DEBUG_CFLAGS) $(COVERAGE_FLAGS) $(GPROF_FLAGS) $(CINC)
REALCXX=$(CXX) $(CXXFLAGS) $(DEBUG_CXXFLAGS) $(COVERAGE_FLAGS) $(GPROF_FLAGS) $(CXXINC)
REALLD=$(LINK) $(LDPATH) $(COVERAGE_LINK) $(GPROF_LINK)
REALAR=$(AR)
REALINSTALL=$(INSTALL)
REALTDR=$(TDR) $(TDRINC)
